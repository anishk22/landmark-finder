...
class LocationsDataService {
    ...
    static let locations: [Location] = [
        ...
        Location(
            ...
            coordinates: CLLocationCoordinate2D(latitude: 37.8199, longitude: -122.4783),
            ...
            imageNames: [
                "sanfrancisco-goldengatebridge-1",
                "sanfrancisco-goldengatebridge-2",
                "sanfrancisco-goldengatebridge-3",
            ],
            link: "https://en.wikipedia.org/wiki/Golden_Gate_Bridge"),
        Location(
            name: "Space Needle",
            cityName: "Seattle",
            coordinates: CLLocationCoordinate2D(latitude: 47.6205, longitude: -122.3493),
            description: "The Space Needle is an observation tower in Seattle, Washington, United States. It was built in 1962 for the 1962 World's Fair and has since become a symbol of Seattle and a major tourist attraction. The tower stands 605 feet tall and offers panoramic views of the city, surrounding mountains, and Puget Sound.",
            imageNames: [
                "seattle-spaceneedle-1",
                "seattle-spaceneedle-2",
                "seattle-spaceneedle-3",
            ],
